...
class VIWCAIO_CART_ALL_IN_ONE_Admin_Settings {
	...
	public static function enqueue_style( $handles = array(), $srcs = array(), $des = array(), $type = 'enqueue' ) {
		...
		foreach ( $handles as $i => $handle ) {
			...
			$action( $handle, VIWCAIO_CART_ALL_IN_ONE_CSS . $srcs[ $i ], ! empty( $des[ $i ] ) ? $des[ $i ] : array(), VIWCAIO_CART_ALL_IN_ONE_VERSION );
		}
	}
	...
	public static function enqueue_script( $handles = array(), $srcs = array(), $des = array(), $type = 'enqueue', $in_footer = false ) {
		...
		foreach ( $handles as $i => $handle ) {
			...
			$action( $handle, VIWCAIO_CART_ALL_IN_ONE_JS . $srcs[ $i ], ! empty( $des[ $i ] ) ? $des[ $i ] : array( 'jquery' ), VIWCAIO_CART_ALL_IN_ONE_VERSION, $in_footer );
		}
	}
