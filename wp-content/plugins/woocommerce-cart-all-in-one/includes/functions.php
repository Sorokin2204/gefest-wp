...
if ( ! function_exists( 'viwcaio_sort_array' ) ) {
	function viwcaio_sort_array( $a, $b ) {
		return $a['priority'] - $b['priority'];
	}
}
if ( ! function_exists( 'viwcaio_stripe_wc_payments' ) ) {
	function viwcaio_stripe_wc_payments( $a ) {
		return str_replace('wc_payment_gateway_','', strtolower($a));
	}
}
