    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new core(".slider-images-01 .swiper", {
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".slider-images-01 .swiper-button-prev",
                        nextEl: ".slider-images-01 .swiper-button-next"
                    },
                    pagination: {
                        el: ".slider-images-01 .slider__pagination",
                        type: "fraction"
                    },
                    on: {}
                });
                new core(".slider-images-02 .swiper", {
                    modules: [ Navigation, Pagination, freeMode ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".slider-images-02 .swiper-button-prev",
                        nextEl: ".slider-images-02 .swiper-button-next"
                    },
                    pagination: {
                        el: ".slider-images-02 .slider__pagination",
                        type: "fraction"
                    },
                    on: {}
                });
                new core(".slider-images-03 .swiper", {
                    modules: [ Navigation, Pagination, freeMode ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".slider-images-03 .swiper-button-prev",
                        nextEl: ".slider-images-03 .swiper-button-next"
                    },
                    pagination: {
                        el: ".slider-images-03 .slider__pagination",
                        type: "fraction"
                    },
                    on: {}
                });
...
*/
        ...
        gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger, TweenMaxWithCSS, Elastic);
        function animation_text_1(element) {
            var newText = "";
            var theText = document.querySelector(element);
            for (let i = 0; i < theText.innerText.length; i++) {
                newText += "<div>";
                if (" " == theText.innerText[i]) newText += "&nbsp;"; else newText += theText.innerText[i];
                newText += "</div>";
            }
            theText.innerHTML = newText;
            var targetsDiv = document.querySelectorAll(element + " div");
            TweenMaxWithCSS.staggerFromTo(targetsDiv, 3, {
                opacity: 0,
                y: 90,
                ease: Elastic.easeOut.config(5, 100)
            }, {
                opacity: 1,
                y: 0,
                ease: Elastic.easeOut.config(10, 100)
            }, .03);
        }
        document.addEventListener("DOMContentLoaded", (function(event) {
            ...
            gsapWithCSS.from(".hero__info", {
                delay: 1,
                opacity: 0,
                duration: 1
            });
            gsapWithCSS.from(".hero__captions", {
                delay: 1,
                opacity: 0,
                duration: 1
            });
            ...
            setTimeout((() => {
                if (document.querySelector(".hero__title")) {
                    document.querySelector(".hero__title").classList.add("_animate");
                    animation_text_1(".hero__title");
                }
                if (document.querySelector(".inspiration__title")) {
                    document.querySelector(".inspiration__title").classList.add("_animate");
                    animation_text_1(".inspiration__title");
                }
                if (document.querySelector(".projects__title")) {
                    document.querySelector(".projects__title").classList.add("_animate");
                    animation_text_1(".projects__title");
                }
                if (document.querySelector(".project__title")) {
                    document.querySelector(".project__title").classList.add("_animate");
                    animation_text_1(".project__title");
                    let test = document.querySelector(".project__title").querySelectorAll("div");
                    for (let index = 0; index < test.length; index++) {
                        const element = test[index];
                        if ("" == element.innerHTML) {
                            let t = element.length;
                            console.log(t);
                        }
                    }
                }
        ...
        const animateProject = () => {
            gsapWithCSS.from(".hero__image img", {
                scrollTrigger: ".hero__image",
                delay: .5,
                opacity: 0,
                y: -200
            });
            gsapWithCSS.from(".hero__image-captions", {
                scrollTrigger: ".hero__image",
                delay: .5,
                opacity: 0,
                x: -200
            });
            gsapWithCSS.from(".projects__title", {
                scrollTrigger: ".projects",
                delay: .3,
                opacity: 0
            });
            gsapWithCSS.from(".projects__info", {
                scrollTrigger: ".projects",
                delay: .3,
                opacity: 0
            });
            gsapWithCSS.from(".projects__row.slider-images-01 .row-project__title", {
                scrollTrigger: ".projects__row.slider-images-01",
                delay: 1,
                x: -100,
                opacity: 0
            });
            gsapWithCSS.from(".projects__row.slider-images-01 .row-project__details", {
                scrollTrigger: ".projects__row.slider-images-01",
                delay: 1,
                opacity: 0
            });
            gsapWithCSS.from(".projects__row.slider-images-01 .row-project__images img", {
                scrollTrigger: ".projects__row.slider-images-01",
                delay: 1,
                opacity: 0,
                y: -200,
            ...
            gsapWithCSS.from(".projects__row.slider-images-02 .row-project__title", {
                scrollTrigger: ".projects__row.slider-images-02",
                toggleClass: {
                    className: "active"
                },
                delay: 1,
            ...
            gsapWithCSS.from(".projects__row.slider-images-02 .row-project__details", {
                scrollTrigger: ".projects__row.slider-images-02",
                delay: 1,
                opacity: 0
            });
            gsapWithCSS.from(".projects__row.slider-images-02 .row-project__images img", {
                scrollTrigger: ".projects__row.slider-images-02",
                delay: 1,
                opacity: 0,
                y: -200,
            ...
            gsapWithCSS.from(".projects__row.slider-images-03 .row-project__title", {
                scrollTrigger: ".projects__row.slider-images-03",
                toggleClass: {
                    className: "active"
                },
                delay: 1,
            ...
            gsapWithCSS.from(".projects__row.slider-images-03 .row-project__details", {
                scrollTrigger: ".projects__row.slider-images-03",
                delay: 1,
                opacity: 0
            });
            gsapWithCSS.from(".projects__row.slider-images-03 .row-project__images img", {
                scrollTrigger: ".projects__row.slider-images-03",
                delay: 1,
                opacity: 0,
                y: -200,
            ...
            gsapWithCSS.from(".grid_list .grid__item-image", {
                scrollTrigger: ".grid_list .grid__item",
                delay: .5,
                opacity: 0,
                y: -20,
                duration: .5
            });
            gsapWithCSS.from(".grid_list .grid__item-title", {
                scrollTrigger: ".grid_list .grid__item",
                delay: .3,
                opacity: 0,
                x: -20,
            ...
            gsapWithCSS.from(".grid_list .grid__item-summary", {
                scrollTrigger: ".grid_list .grid__item",
                delay: .2,
                opacity: 0,
                duration: .4
            });
            gsapWithCSS.from(".grid_list .grid__item-meta", {
                scrollTrigger: ".grid_list .grid__item",
                delay: .2,
                opacity: 0,
                duration: .4
            });
            gsapWithCSS.from(".inspiration__more .button", {
                scrollTrigger: ".inspiration__more",
                delay: .7,
                opacity: 0,
                duration: .4
            });
            gsapWithCSS.from(".toolbar", {
                scrollTrigger: ".toolbar",
                delay: .7,
                opacity: 0,
                duration: .4
            });
        ...
        animateProject();
        const headerHeight = () => {
            const headerHeig = document.querySelector(".header").offsetHeight;
            const page = document.querySelector(".page");
            page.style.paddingTop = headerHeig + 37 + "px";
            console.log(headerHeig);
        };
        headerHeight();
        window["FLS"] = true;
        isWebp();
